...
//                  Email: wuhongjun@ntu.edu.sg
// This code was written by Hongjun Wu on March 31, 2014.


// t_cost is a non-negative integer not larger than 20;
// m_cost is a non-negative integer not larger than 20;
// it is recommended that:  10 <= t_cost + m_cost <= 20;
// we recommend the parameters: m_cost = 12; t_cost = 0;
...
int PHS(void *out, size_t outlen, const void *in, size_t inlen, const void *salt, size_t saltlen, unsigned int t_cost, unsigned int m_cost)
{
    ...
    if (outlen > 128)   // the maximum output size is 128 bytes.
    {
